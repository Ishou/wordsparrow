...
| `billing/`  | `domain/` `application/` `infrastructure/` `api/` `worker/` | Kotlin/JVM + Ktor; Postgres via CNPG + Flyway; Mollie adapter (ADR-0078)       | `billing/api/openapi.yaml` + `billing/api/asyncapi.yaml`         |
