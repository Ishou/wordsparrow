...
const tagFree = css({ fontFamily: 'wsUi', fontSize: '9.5px', fontWeight: 'black', letterSpacing: '0.05em', textTransform: 'uppercase', color: 'ws.khaki', bg: 'rgba(33,75,64,0.07)', _dark: { bg: 'rgba(233,242,236,0.08)' }, borderRadius: '999px', padding: '3px 9px' });
