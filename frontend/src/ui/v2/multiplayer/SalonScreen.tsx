...
const sizeOptionActive = css({ bg: 'ws.jadeInk', color: 'ws.onJadeInk', borderColor: 'ws.jadeInk' });
...
const startButton = css({
  ...
  _hover: { bg: '#A63C61' },
  _focusVisible: { outline: '3px solid token(colors.ws.sakuraRose)', outlineOffset: '2px' },
  _disabled: { bg: '#E0DAC8', color: '#7A7560', _dark: { bg: '#2E3A28', color: '#8B9584' }, boxShadow: 'none', cursor: 'not-allowed' },
});
