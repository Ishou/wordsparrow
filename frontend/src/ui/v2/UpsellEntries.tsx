...
const card = css({ display: 'flex', alignItems: 'center', gap: '12px', width: '100%', textAlign: 'left', textDecoration: 'none', bg: 'ws.card', border: '1.5px solid token(colors.ws.sakuraBlush)', borderRadius: '16px', padding: '13px 14px', cursor: 'pointer', boxShadow: '0 1px 2px rgba(33,75,64,0.06)', fontFamily: 'wsUi', transition: 'border-color 120ms, box-shadow 120ms, transform 120ms', _hover: { borderColor: 'ws.sakuraRose', boxShadow: '0 3px 10px rgba(33,75,64,0.12)', transform: 'translateY(-1px)' }, _focusVisible: { outline: '3px solid token(colors.ws.sakuraRose)', outlineOffset: '2px' } });
