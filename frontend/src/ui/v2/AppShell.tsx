...
export interface AppShellProps {
  ...
  // Page-supplied desktop bar in both variants (e.g. grid pages needing a timer/sound trailing the generic navActive bar can't carry). `null` renders no desktop bar; `undefined` falls back to the default DesktopAppBar.
