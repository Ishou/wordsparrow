// Copied from grid/infrastructure/src/main/kotlin/com/bliss/grid/infrastructure/persistence/BlissDatabase.kt
// per ADR-0039. Konsist forbids cross-context imports; this is the chosen trade-off.
// Keep in sync deliberately — divergence is acceptable if game's needs differ from grid's.
...
/**
 * Shared Postgres bootstrap for `game-api` (ADR-0039, ADR-0009).
 *
...
class BlissDatabase(
    ...
    companion object {
        private const val LOGGER_BASE = "com.bliss.game.infrastructure.persistence.BlissDatabase"
