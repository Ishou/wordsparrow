...
ADR-0064  frontend/lighthouserc.cjs                EcoIndex + perf assertions; Lighthouse a11y category disabled (axe canonical per ADR-0050)
ADR-0064  .github/workflows/lighthouse.yml         EcoIndex baseline workflow; workflow_run on Deploy Frontend; Pages preview or wordsparrow.io
