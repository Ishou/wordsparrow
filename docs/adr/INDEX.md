...
ADR-0119  scripts/grid_family/build_derivational_family_edges.py  Folds `complexite=simple` Démonette relations to grid-cell A-Z lemma pairs (roadmap item 1, shipped); output is NOT committed here (ADR-0058 redistribute-forbidden) — regenerate into the private corpus-dir bucket (`morphology/derivational_family_edges.csv`, ADR-0097) on a Démonette ingest bump
