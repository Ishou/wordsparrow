...
ADR-0069  .github/workflows/issue-dev-chatops.yml    Comment-driven ChatOps agents (/respec /correct /answer /replan /correct-plan); maintainer steering is a binding directive, not "data"
