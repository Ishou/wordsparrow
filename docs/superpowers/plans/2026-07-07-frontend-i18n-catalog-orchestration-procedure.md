...
| P5c v2-account-legal | `refactor/i18n-v2-account-legal` | `main` | `refactor(frontend): i18n v2 account + legal screens` | v2 account/legal/info: `CompteScreen`, `ReglagesScreen`, `ConnexionScreen`, `EraseData`, `AProposScreen`, `AideScreen`, `ConfidentialiteScreen`, `MentionsLegalesScreen` (~8; legal screens may be French-only long prose — catalogue, or defer any bilingual one). |
