...
> **Status: Shipped 2026-07-05** — landed as ADR-0096 (#1408), grid domain/ingest (#1409), and schema + API producer + frontend consumer (#1402). Retained as the historical implementation record; the task checkboxes below reflect the original breakdown, not remaining work.
