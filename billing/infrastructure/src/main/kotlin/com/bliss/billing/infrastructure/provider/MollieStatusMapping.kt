...
/** Maps Mollie payment/subscription status strings to the domain lifecycle; `null` means "no actionable entitlement state yet" so the caller drops the callback (ADR-0078). */
