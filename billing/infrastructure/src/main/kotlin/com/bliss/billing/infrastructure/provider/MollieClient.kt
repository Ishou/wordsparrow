...
interface MollieClient {
    ...
    /** Backfills the email on an existing provider Customer created before the email was known; billing passes it through and stores none of it (ADR-0082). */
    suspend fun updateCustomerEmail(
        customerId: String,
        email: String,
    )
