...
/** In-memory OutboundEmailStore for application-layer tests; mirrors the Postgres semantics (dedupe-key idempotency, due-row claiming, state transitions) without infrastructure. */
